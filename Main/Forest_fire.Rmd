...
forest <- read.csv("C:/Users/main/Desktop/Forest-Fires/Dataset&Documentation/forestfires.csv")
...
# Modello con poche:
model1 = lm(area ~ month_aug+wind+temp+DMC, data = train)
summary(model1)
...
model2 = lm(area ~ month_aug+wind+temp+DMC, data = train)
summary(model2)
