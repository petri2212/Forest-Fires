...
forest <- read.csv("C:/Users/petri/Desktop/UNI ANNO 2/Statistic/PROGETTO/Forest_fire/forestfires.csv")
...
plot(density(log(forest$area)), col="green")
