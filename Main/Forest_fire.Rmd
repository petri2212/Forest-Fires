...
forest$month <- factor(forest$month, levels = c('jan', 'feb', 'mar', 'apr', 'may', 'jun', 'jul', 'aug', 'sep', 'oct', 'nov', 'dic'))
forest$day <- factor(forest$day, levels = c('mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'))
...
plot(density(forest$area), col="blue")
# E' molto asimmetrica verso lo 0, proviamo a farne una trasformata:
plot(density(log(forest$area)), col="blue")
