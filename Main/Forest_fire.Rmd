...
hist((log(forest$area+1)), col = "red", breaks=15, ylab = "Frequency", xlab = "Hectars", main = "Ln transform")
```
...
```{r echo=F, message=F,fig.show="hold", out.width="50%", echo=F, message=F}
...
boxplot(forest[,-c(1,2)], main="variables", col=rainbow(9))

# c'è differenza nei giorni?
boxplot(forest$area ~ forest$day, xlab = "area", ylab = "day", main="week", col=rainbow(7))
# cosa succede a Dicembre?
boxplot(forest$area ~ forest$month, xlab = "area", ylab = "mounth", main="year", col=rainbow(12)) 
```
