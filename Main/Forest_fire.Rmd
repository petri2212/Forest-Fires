...
hist(forest$area, col = "red", breaks=15, main = "Burned area in Hectars")
# Histogramma di prima considerato tramite il logaritmo
hist((log(forest$area+1)), col = "red", breaks=15, main = "Ln transform")
```
...
boxplot(forest$area ~ forest$day, col=rainbow(7))
# cosa succede a Dicembre?
boxplot(forest$area ~ forest$month, col=rainbow(12)) 
```
